// src/modulos/suscripcion/componentes/UsoWidget.tsx
  ...
  return (
    <div style={est.contenedor}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        ...
        <span style={{
          background: C.primario + '15', color: C.primario,
            ...
            <div key={r.etiqueta}>
              ...
              <div style={{ height: 5, borderRadius: 3, background: '#f3f4f6' }}>
                <div style={{
                  ...
                  height: '100%', borderRadius: 3, background: color, transition: 'width 0.4s ease',
                }} />
              </div>
            </div>
          );
      ...
      <a href="/suscripcion" style={{
        ...
        fontSize: '0.8rem', color: C.primario, fontWeight: 600, textDecoration: 'none',
      }}>
...
const est = {
  contenedor: {
    background: '#fff', borderRadius: 12, padding: 20, border: `1px solid ${C.borde}`,
