...
const estilos = {
  ...
  planNombre: { fontSize: '1.35rem', fontWeight: 700, color: colores.texto, margin: 0 },
  precio: { display: 'flex', alignItems: 'baseline', gap: 4 },
  precioNumero: { fontSize: '2.5rem', fontWeight: 800, color: colores.texto },
  precioPeriodo: { fontSize: '1rem', color: colores.textoSecundario },
  ahorro: { background: '#fef3c7', color: '#92400e', padding: '4px 12px', borderRadius: 8, fontSize: '0.8rem', fontWeight: 600, display: 'inline-block' },
  ...
  extras: { textAlign: 'center' as const, marginTop: 40, color: colores.textoSecundario, fontSize: '0.85rem' },
};
        ...
        {planesVisibles.map((plan) => {
          ...
          return (
            ...
            >
              ...
              {esActual && <div style={{ ...estilos.badge, background: '#10b981' }}>Tu plan actual</div>}
