...
func NewWhatsAppConfigController(canalRepo *repo.CanalWhatsAppRepo) *WhatsAppConfigController {
	return &WhatsAppConfigController{canalRepo: canalRepo}
}
